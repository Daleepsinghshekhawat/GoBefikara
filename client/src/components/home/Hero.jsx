...
const SLIDER_IMAGES = [
  "/images/trips/banner1.jpg",
  "/images/trips/banner2.jpg",
  "/images/trips/banner3.jpg",
  "/images/trips/banner4.jpg",
  "/images/trips/banner5.jpg",
];
...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* ── Auto-scrolling background slider ── */}
      <div
        ...
        {SLIDER_IMAGES.map((src, index) => (
          <img
            ...
            style={{
              ...
              opacity: index === slideIndex ? 1 : 0.8,
            }}
          />
        ))}
      </div>
      ...
      <div
        style={{
          ...
          zIndex: 1,
          background:
            "linear-gradient(105deg, rgba(8,8,20,0.55) 0%, rgba(8,8,20,0.35) 45%, rgba(8,8,20,0.15) 75%, rgba(8,8,20,0.05) 100%)",
        }}
      />
      ...
      >
        ...
        >
          ...
          <div style={{ flex: "0 0 auto", maxWidth: 520 }}>
            ...
            >
              Explore the most sacred Shiv temples across the Himalayas. Ancient
              energy. Eternal peace. Your spiritual awakening begins here.
            </motion.p>
            ...
            {SACRED_LIST.map((item, i) => (
              ...
              >
                  ...
                  {i < SACRED_LIST.length - 1 && (
                    <div
                      style={{
                        ...
                        height: 38,
                        background:
                          "linear-gradient(to bottom, rgba(255,140,92,0.5), rgba(255,140,92,0.15))",
                      }}
                    />
                  )}
                </div>
                ...
                <div
                  style={{
                    paddingTop: "0.45rem",
                    paddingBottom: i < SACRED_LIST.length - 1 ? "0.5rem" : 0,
                  }}
                >
                  <div
                    style={{
      ...
      >
        ...
        >
          {STATS.map((s, i) => (
            ...
            >
              <span style={{ fontSize: "1.6rem", opacity: 0.85 }}>
                {s.icon}
              </span>
              <div>
                <div
